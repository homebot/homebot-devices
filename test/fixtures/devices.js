...
const mongoDBfixtures = require('pow-mongodb-fixtures');

exports.devices = {
  userDevice1: {
    _id: mongoDBfixtures.createObjectId('59b50d152d9f6b4110ec0000'),
    type: 'light',
    image: {
  ...
  userDevice2: {
    _id: mongoDBfixtures.createObjectId('59b50d152d9f6b4110ec0001'),
    type: 'light',
    image: {
  ...
  userDevice3: {
    _id: mongoDBfixtures.createObjectId('59b50d152d9f6b4110ec0002'),
    type: 'light',
    image: {
